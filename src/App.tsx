...
function Home() {
  return     <main style={{maxWidth: 1024, margin: "auto"}}>
...
function App() {
  return (
    <Router>
    <div className="App">
      <header style={{height: 50, background: "rgb(40, 150, 241)", display: "flex", justifyContent: "space-between", alignItems: "center", paddingLeft: 16, paddingRight: 16}}>
        <h2 style={{margin: 0, color: "white"}}>UGCS</h2>
        <div>
        <Link to="/" style={{marginLeft: 16, color: "white", textDecoration: "underline"}}>Home</Link>
        <Link to="/projects" style={{marginLeft: 16, color: "white", textDecoration: "underline"}}>Projects</Link>
        </div>
      </header>
      <Switch>
        <Route exact path="/">
